...
<input type="hidden" name="action" value="save_public_link">
...
for(const button of document.querySelectorAll('.sync-btn')){
  button.addEventListener('click',async()=>{
    ...
    try{
      const body=new URLSearchParams({instance_id:id}); const r=await fetch('/sync-start.php',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded'},body}); const d=await r.json();
